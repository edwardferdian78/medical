function searchLocation() {
    ...
    dir.on('success', function (data) {
        ...
        $('#ambulance-alamat').val(data.route.locations[1].street + " " + data.route.locations[1].adminArea5);
        $('#ambulance-jarak').val(parseFloat(data.route.distance).toFixed(2));
        $('#ambulance-harga').val(Math.floor(parseFloat(data.route.distance) * 20) * 1000);
    });
}
//  {
